...
<template>
  ...
  <div class="relative z-10 bg-[#2B3B4C] py-20 rounded-[3rem] -mt-10 mb-20 shadow-[0_0_80px_rgba(0,0,0,0.15)]">
    ...
    <section class="w-full h-auto">
      <div class="w-full max-w-[95%] xl:max-w-4/5 mx-auto py-20">
        <h2 class="text-4xl lg:text-6xl capitalize font-semibold text-center text-white page-animation mb-10" :class="{ 'show': isAnimate }">
          Our Profile
        </h2>

        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-10 mt-10 items-center page-animation" :class="{ 'show': isAnimate }">
