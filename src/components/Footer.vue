            ...
            <div class=" grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 xl:gap-4">
                ...
                <div class=" min-h-60 flex flex-col items-start relative">
                    ...
                    <div class="flex absolute bottom-0 left-0">
                        ...
                        <div
                            class=" w-13 h-13 bg-[#FF0000] text-white rounded-full mr-2 text-2xl flex justify-center items-center transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" fill="currentColor" fill-rule="evenodd" class="w-8 h-8"><path d="M818 800 498.11 333.745l.546.437L787.084 0h-96.385L455.738 272 269.15 0H16.367l298.648 435.31-.036-.037L0 800h96.385l261.222-302.618L565.217 800zM230.96 72.727l448.827 654.546h-76.38L154.217 72.727z" transform="translate(103 112)"/></svg>
                        </div>
