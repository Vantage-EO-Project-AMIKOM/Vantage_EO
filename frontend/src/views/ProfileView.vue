...
onMounted(() => {
  ...
  // Mengaktifkan efek transisi Pop Up teks utama & section pertama
  setTimeout(() => {
  ...
  // HANYA mengobservasi elemen dengan class .scroll-animate (bagian judul & kartu profile)
...
<template>
  ...
  <section class="w-full h-130 z-10 flex items-center relative overflow-hidden">
    ...
    <div class="w-full max-w-3/4 mx-auto z-10 transition-all duration-1000 transform scale-95 opacity-0 ease-out"
      ...
      <p class=" text-xl font-normal text-white">A trusted event management platform designed to empower creators,
        speakers, </p>
      <p class=" text-xl font-normal text-white">and audiences through seamless event creation and professional
        collaboration.</p>
    </div>
  </section>
  ...
  <div
    ...
    <!-- SECTION 1: DID YOU KNOW US? -->
    <section class="max-w-7/8 w-full mx-auto page-animation" :class="{ show: isAnimate }">
      <div
        class="bg-linear-to-br from-[#24364d] to-[#1d2d42] border border-white/10 ring-1 ring-white/40 shadow-[0_10px_40px_rgba(0,0,0,0.35)] p-8 md:p-16 rounded-[40px] md:rounded-[60px] text-center">

        <!-- Judul dengan Spasi Elegan dan Border Bawah Tipis -->
        <div class="inline-block mb-10">
          <h2 class="text-4xl md:text-5xl lg:text-6xl capitalize font-bold text-white tracking-wide">
            Did You Know Us?
          </h2>
          <div
            class="w-24 h-1 bg-linear-to-r from-transparent via-[#EE0034] to-transparent mx-auto mt-4 rounded-full">
          </div>
        </div>

        <!-- Container Teks dengan Batas Lebar Nyaman Dibaca -->
        <div
          class="max-w-4xl mx-auto space-y-6 text-white/90 text-base md:text-lg leading-relaxed text-justify md:text-center">
          <p class="indent-8 md:indent-0">
    ...
    <section class="w-full h-auto">
      <div class="w-full max-w-[95%] xl:max-w-4/5 mx-auto py-20">
        <h2 class="text-4xl lg:text-6xl capitalize font-semibold text-center text-white mb-10 scroll-animate">
          Our Profile
        </h2>

        <!-- Profile 1: Azka (Menggunakan scroll-animate untuk efek gulir interaktif) -->
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-10 mt-10 items-center scroll-animate">
          ...
          <div
            ...
            <a href="https://github.com/MehmedAzka" target="_blank" rel="noopener noreferrer"
              class="group inline-flex justify-start items-center gap-3 mt-10 w-fit">
              ...
              <h5 class="text-white text-lg lg:text-2xl ml-3 transition-colors duration-300 group-hover:text-[#EE0034]">
                MehmedAzka</h5>
            </a>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-10 mt-10 items-center scroll-animate">
          <div
            ...
            <h2 class="text-2xl lg:text-4xl capitalize font-semibold mb-2 text-left lg:text-right text-white">
              Puan Aeesya
            </h2>
            <h2 class="text-2xl lg:text-4xl capitalize font-semibold mb-8 text-left lg:text-right text-white">
              24.61.0274
            </h2>
            ...
            <a href="https://github.com/syaaaa07" target="_blank" rel="noopener noreferrer"
              class="group flex justify-start lg:justify-end items-center gap-3 mt-10 w-full lg:w-auto ml-auto">
              <h5
                class="text-white text-lg lg:text-2xl mr-3 lg:ml-3 transition-colors duration-300 group-hover:text-[#EE0034]">
                syaaaa07</h5>
              <img src="./../components/img/profilePage/githubicon.png" alt="github_icon"
                class="w-10 h-10 lg:w-auto transition-transform duration-300 group-hover:scale-105" />
            </a>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-10 mt-10 items-center scroll-animate">
          ...
          <div
            ...
            <a href="https://github.com/agashesh" target="_blank" rel="noopener noreferrer"
              class="group inline-flex justify-start items-center gap-3 mt-10 w-fit">
              <img src="./../components/img/profilePage/githubicon.png" alt="github_icon"
                class="w-10 h-10 lg:w-auto transition-transform duration-300 group-hover:scale-105" />
              <h5 class="text-white text-lg lg:text-2xl ml-3 transition-colors duration-300 group-hover:text-[#EE0034]">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-10 mt-10 items-center scroll-animate">
          <div
            ...
            <a href="https://github.com/Danizakhran" target="_blank" rel="noopener noreferrer"
              class="group flex justify-start lg:justify-end items-center gap-3 mt-10 w-full lg:w-auto ml-auto">
              <h5
                class="text-white text-lg lg:text-2xl mr-3 lg:ml-3 transition-colors duration-300 group-hover:text-[#EE0034]">
                Danizakhran</h5>
...
<style scoped>
/* ===================================================
   1. ANIMASI POP UP MURNI (Hero & Did You Know)
   =================================================== */
@keyframes heroScale {
  0% {
...
/* Transisi Pop Up Murni untuk Section Did You Know */
.page-animation {
  opacity: 0;
